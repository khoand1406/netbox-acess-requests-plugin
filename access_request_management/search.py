"""
Search indexes for access_request_management.
...
class Access_RequestIndex(SearchIndex):
    """
    Search index for Access_Request model.

    This enables Access_Request objects to appear in NetBox's global
    search results.
    """
    ...
    # category = 'access_request_management'
