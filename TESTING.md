# Testing Guide for access_request_management

This guide explains how to write and run tests for access_request_management.

## Test Structure

Tests are organized in the `access_request_management/tests/` directory:
...
```python
from access_request_management.testing import PluginTestCase
...
```python
from access_request_management.testing import PluginModelTestCase
...
```python
from access_request_management.testing import PluginAPITestCase

class MyAPITestCase(PluginAPITestCase):
    def setUp(self):
        super().setUp()
        self.list_url_name = 'plugins-api:access_request_management-api:mymodel-list'
        self.detail_url_name = 'plugins-api:access_request_management-api:mymodel-detail'
...
```python
from access_request_management.testing import PluginViewTestCase

class MyViewTestCase(PluginViewTestCase):
    def setUp(self):
        super().setUp()
        self.base_url = 'plugins:access_request_management:mymodel'
...
```python
from access_request_management.testing import PluginGraphQLTestCase
...
The `access_request_management.testing.utils` module provides helpful utilities:

```python
from access_request_management.testing.utils import (
...
user = create_test_user(permissions=['access_request_management.view_accessrequest'])
...
python manage.py test access_request_management.tests

# Run specific test file
python manage.py test access_request_management.tests.test_models

# Run specific test class
python manage.py test access_request_management.tests.test_models.Access_RequestTestCase

# Run specific test method
python manage.py test access_request_management.tests.test_models.Access_RequestTestCase.test_create

# Run with verbose output
python manage.py test access_request_management.tests -v 2

# Run in parallel (faster)
python manage.py test access_request_management.tests --parallel

# Keep database between runs (faster during development)
python manage.py test access_request_management.tests --keepdb
```
...
# Run tests
docker-compose exec netbox python manage.py test access_request_management.tests

# Run specific tests
docker-compose exec netbox python manage.py test access_request_management.tests.test_api
...
def test_form_validation(self):
    ...
    url = reverse('access_request_management:mymodel_add')
...
**"No module named 'access_request_management'"**
